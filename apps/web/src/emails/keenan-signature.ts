 ...
 * deployed so it's accessible at https://goripple.io/email/keenan-headshot.png.
 */
...
export function keenanSignatureHtml(): string {
  ...
  <tr>
    <td style="padding-right: 16px; vertical-align: top;">
      <img src="https://goripple.io/email/keenan-headshot.png" alt="Keenan" width="72" height="72" style="border-radius: 50%; display: block;" />
    </td>
    <td style="vertical-align: top;">
      <table cellpadding="0" cellspacing="0" border="0">
        <tr><td style="font-size: 16px; font-weight: 600; color: #181614; padding-bottom: 2px;">Keenan Assaraf</td></tr>
        <tr><td style="font-size: 13px; color: #666666; padding-bottom: 8px;">Co-Founder &middot; <a href="https://goripple.io" style="color: #8E6FE6; text-decoration: none;">Ripple</a></td></tr>
        <tr><td style="border-top: 1px solid #E8DDD0; padding-top: 8px;">
          <table cellpadding="0" cellspacing="0" border="0">
            ...
            <tr><td style="font-size: 12px; padding-top: 4px;"><a href="https://goripple.io" style="color: #8E6FE6; text-decoration: none;">goripple.io</a>&nbsp;&nbsp;<a href="https://apps.apple.com/us/app/acuity-daily/id6762633410" style="color: #8E6FE6; text-decoration: none;">App Store</a></td></tr>
          </table>
        </td></tr>
      </table>
    </td>
