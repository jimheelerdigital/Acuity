...
export const milestone10: TrialEmailTemplate = {
  ...
  html: (v: TrialVars) => {
    ...
    const content = `
      ...
      ${para(`I\u2019m curious how it\u2019s landing for you. Is Acuity catching the things that matter? Are the patterns starting to feel useful? Anything that\u2019s clicked, or anything that\u2019s bugged you?`)}
      ...
      ${para(`And if you\u2019re already loving it \u2014 one small thing. We\u2019re a small company trying to grow and help more people do what you\u2019re doing, and honestly, each App Store review means the world to us. If Acuity\u2019s been good to you, we\u2019d be grateful if you left one.`)}
      <tr>
