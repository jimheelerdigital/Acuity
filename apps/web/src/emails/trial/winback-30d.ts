...
export const winback30d: TrialEmailTemplate = {
  ...
  html: (v: TrialVars) => {
    ...
    const content = `
      ...
      ${para(`Acuity exists to help you get where you were trying to go \u2014 clearer on your patterns, on top of your tasks, less lost in the blur of your weeks. We want to help you actually get there.`)}
