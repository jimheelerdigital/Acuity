...
export const milestone50: TrialEmailTemplate = {
  ...
  html: (v: TrialVars) => {
    ...
    const content = `
      ...
      ${para(`Which is exactly why I want to ask: what has Ripple actually done for you? Has it helped you notice something you\u2019d been missing? Stay on top of things you used to drop? See a pattern that changed how you do things?`)}
