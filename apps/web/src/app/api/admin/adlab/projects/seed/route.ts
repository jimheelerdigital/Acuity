/**
 * POST /api/admin/adlab/projects/seed — create the initial Ripple project
...
Show artifacts (the weekly report, the memoir PDF), not mechanisms.`,
      targetAudience: {
        ...
        desires: [
          ...
          "a ritual that takes almost no time, not 20 minutes",
      ...
      usps: [
        "voice entry pulls out tasks and tracks goals automatically",
