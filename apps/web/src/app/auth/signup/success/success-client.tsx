    ...
    <div className="min-h-screen bg-acuity-bg text-[#F5EDE4]">
      ...
      <div className="flex flex-col items-center justify-center px-6 pt-16 pb-10 sm:pt-24 sm:pb-14">
        <div className="w-full max-w-md text-center">
          <div className="mb-6">
            <Image src="/ripple-mark-white.png?v=2" alt="Ripple" width={64} height={64} className="mx-auto" />
          </div>
          ...
          <p className="mt-4 text-sm text-amber-400/80">
            Your 7-day free trial has started — don&rsquo;t let it tick away in silence.
          </p>
