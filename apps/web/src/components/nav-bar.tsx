...
export function NavBar() {
  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-zinc-200 dark:border-white/10 bg-[#FAFAF7]/80 dark:bg-[#0B0B12]/80 backdrop-blur-md lg:hidden">
      <div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-3">
        ...
        <div className="flex items-center gap-6">
          ...
          >
            <Image src="/ripple-mark-coral.png?v=2" alt="Ripple logo" width={32} height={32} className="shrink-0" />
