...
export function BlogCtaButtons() {
  return (
    <div className="flex items-center justify-center">
      ...
      >
        <span className="absolute inset-[-100%] animate-cta-shine" style={{ background: 'conic-gradient(from 0deg, transparent 0%, transparent 60%, #ffffff 75%, var(--acuity-primary-hi) 85%, transparent 100%)' }} />
