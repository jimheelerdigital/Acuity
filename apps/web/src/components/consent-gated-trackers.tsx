...
export function ConsentGatedTrackers() {
  ...
  return (
    <>
      ...
      {/* Meta Pixel — always loaded. Required for ad attribution
          (CompleteRegistration, Purchase, etc.) which is the primary
          revenue driver. Without it, Meta can't match conversions to
          ad clicks and CPA optimization breaks. The pixel sets _fbp
          and _fbc cookies that CAPI needs for server-side matching.
          GA4 + session recording remain consent-gated. */}
