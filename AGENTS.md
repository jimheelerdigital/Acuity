...
This repo uses the existing progress.md at the root as the single source of truth for code changes. Both cofounders ship through Codex. These rules apply to every session.
...
Every commit Codex makes in this repo must follow this format:
